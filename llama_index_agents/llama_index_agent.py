...
# # Create the FunctionAgent with all our tools
# agent = FunctionAgent(
#     tools=[
...
#         brand_colors = input("Enter brand colors (hex codes or names): ")
#         visual_style = input("Enter desired visual style: ")
        
#         print(f"\n🚀 Processing brand image generation for {product_name}...")
